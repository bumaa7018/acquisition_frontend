...
// Серверийн алдааны БҮТЭН хуудас.
//
// API-ийн алдаа (5xx/timeout) хэрэглэгчийг ЭНД ШИДЭХЭЭ БОЛЬСОН — тэр нь одоо
// зөвхөн toast анхааруулга (lib/api.ts → showServerError) болж, хэрэглэгч
// хуудсандаа үлдэж ажлаа үргэлжлүүлнэ. Хуудас байхгүй бол app/not-found.tsx,
// рендер эвдэрвэл app/error.tsx харагдана.
//
// Энэ хуудас нь гараар/хуучин линкээр хандахад л үлдсэн бөгөөд ямар ч API
// дуудахгүй — дахин оролдох/нүүр хуудас руу буцах сонголт өгнө.
