      ...
      <div className="w-full max-w-md space-y-6">
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-white">Газрын Мэдээллийн Систем</h1>
        ...
        <Card className="border-slate-700 bg-slate-800/50 backdrop-blur shadow-2xl">
          <CardHeader>
            ...
            <CardDescription className="text-slate-400">Имэйл болон нууц үгээ оруулна уу</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="email" className="text-slate-300">Имэйл</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="text-slate-300">Нууц үг</Label>
                <Input
