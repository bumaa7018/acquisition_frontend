...
export const INVOICES: Invoice[] = [
  {
    ...
    items: [
      {
        id: "1",
        description: "Газрын нэгж талбарын үнэлгээ (#ГН-2456)",
        unit: "м²",
        qty: 250,
        unitPrice: 120_000,
      },
      {
        id: "2",
        description: "Барилга байгууламжийн нөхөн олговор",
        unit: "тоо",
        qty: 1,
    ...
    notes:
      "Нөхөн олговрын гэрээ №2024/01/15-001 дагуу. Төлбөр нь Монгол банк дахь 5002345678 тоот дансанд.",
  },
  {
    id: "2",
    number: "НЭХ-2024-002",
    ...
    items: [
      {
        id: "1",
        description: "Газрын нэгж талбарын үнэлгээ (#ГН-2457)",
        unit: "м²",
        qty: 320,
        unitPrice: 130_000,
      },
      {
        id: "2",
        description: "Гэрийн нөхөн олговор",
        unit: "тоо",
        qty: 1,
        unitPrice: 20_900_000,
      },
    ],
  ...
  },
  {
    ...
    items: [
      {
        id: "1",
        description: "Газрын нэгж талбарын үнэлгээ (#ГН-2458)",
        unit: "м²",
        qty: 200,
        unitPrice: 115_000,
      },
  ...
  },
  {
    ...
    items: [
      {
        id: "1",
        description: "Газрын нэгж талбарын үнэлгээ (#ГН-2459)",
        unit: "м²",
        qty: 290,
        unitPrice: 125_000,
      },
  ...
  },
  {
    ...
    items: [
      {
        id: "1",
        description: "Газрын нэгж талбарын үнэлгээ (#ГН-2460)",
        unit: "м²",
        qty: 380,
        unitPrice: 135_000,
      },
      {
        ...
        unit: "тоо",
        qty: 1,
        unitPrice: 19_950_000,
      },
      {
        id: "3",
        description: "Нүүлгэн шилжүүлэлтийн зардал",
        unit: "тоо",
        qty: 1,
        unitPrice: 2_000_000,
      },
  ...
  },
  {
    ...
    items: [
      {
        id: "1",
        description: "Газрын нэгж талбарын үнэлгээ (#ГН-2461)",
        unit: "м²",
        qty: 180,
        unitPrice: 110_000,
      },
  ...
  },
  {
    ...
    items: [
      {
        id: "1",
        description: "Газрын нэгж талбарын үнэлгээ (#ГН-2462)",
        unit: "м²",
        qty: 450,
        unitPrice: 145_000,
      },
  ...
  },
  {
    ...
    items: [
      {
        id: "1",
        description: "Газрын нэгж талбарын үнэлгээ (#ГН-2463)",
        unit: "м²",
        qty: 220,
        unitPrice: 120_000,
      },
  ...
  },
  {
    ...
    items: [
      {
        id: "1",
        description: "Газрын нэгж талбарын үнэлгээ (#ГН-2464)",
        unit: "м²",
        qty: 340,
        unitPrice: 130_000,
      },
  ...
  },
  {
    ...
    items: [
      {
        id: "1",
        description: "Газрын нэгж талбарын үнэлгээ (#ГН-2465)",
        unit: "м²",
        qty: 270,
        unitPrice: 128_000,
      },
