      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-5 items-start">
        ...
        <div className="xl:col-span-2 flex flex-col gap-5">
          ...
          <div className="ap-card p-6">
            <h2 className="text-[13px] font-bold text-slate-700 uppercase tracking-wide mb-4">
                ...
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-100">
                    {[
                      ...
                      <th
                        key={h}
                        className="px-3 py-2.5 text-left text-[11px] font-semibold uppercase tracking-wide text-slate-400"
                      >
                        {h}
                      </th>
                    ))}
                    ...
                    <tr key={item.id}>
                      ...
                      <td className="px-3 py-2 w-20">
                        <select
                          value={item.unit}
                          onChange={(e) =>
                            setItemField(item.id, "unit", e.target.value)
                          }
