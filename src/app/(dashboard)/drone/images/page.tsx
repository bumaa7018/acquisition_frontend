...
export default function DroneImagesPage() {
  return (
    <Suspense fallback={null}>
      <DroneImagesPageContent />
    </Suspense>
  );
}

function DroneImagesPageContent() {
  ...
  function selectAcquisition(id: string) {
    ...
    router.replace(`/drone/images${params.toString() ? `?${params.toString()}` : ""}`, {
      scroll: false,
    });
  }
