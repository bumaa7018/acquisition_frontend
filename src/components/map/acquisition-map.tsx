...
export function AcquisitionMap({
  ...
  // Ажлын зураг — ДАШБОАРДТАЙ ИЖИЛ цонх (print-map-dialog). Хэвлэх бүх
  // логик тэнд НЭГ л газарт байна: хоёр урсгал зөрөх боломжгүй.
  const [printOpen, setPrintOpen] = useState(false);


  /* ?print=1 — дашбоард/шууд холбоосоор ирсэн бол Ажлын зургийн цонхыг
     ӨӨРӨӨ нээнэ. Зураг бэлдэх ажлыг цонх өөрөө хийнэ. */
  useEffect(() => {
