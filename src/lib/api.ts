...
import type {
  ...
  DroneAcquisition,
  CompensationHistory, AuthorizedRepresentative, ParcelHolder, RepresentativeInput, ParcelDocumentSyncResult, ParcelHolderSyncResult, ParcelBasePrice, ParcelInvoiceSyncResult, ParcelSyncCountResult, LandValuation, LandValuationUpsert, ValuationImportPayload, ValuationImportResult, AssetSpec, AssetCalculation,
  DroneImage,
  DroneUploadTicket,
